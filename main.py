...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        Bgimg= Image.open(r"background/bg_img.jpg")
        ...
        #button_images
        img1 =Image.open(r"project_images/image2.jpg")
        ...
        img2 =Image.open(r"project_images/face_detect.jpg")
        ...
        #attendance button
        img3 =Image.open(r"project_images/image4.jpg")
        ...
        #help desk
        img4 =Image.open(r"project_images\image3.jpg")
        ...
        #train buttom
        img5 =Image.open(r"project_images\image6.jpg")
        ...
        #photos button
        img6 =Image.open(r"project_images\image5.jpg")
        ...
        #developer button
        img7 =Image.open(r"project_images\developer.jpeg")
        img7.thumbnail((220, 260), Image.LANCZOS)
        self.photoimg7 = ImageTk.PhotoImage(img7)

        b7= Button(root,cursor="hand2",command=self.developer,image = self.photoimg7)
        b7.place(x=700,y=400,width=220,height=220)

        b7_title = Button(root, text="Developer",command=self.developer,cursor="hand2" ,font=("Arial", 12, "bold"), bg="white", fg="black")
        b7_title.place(x=700, y=600, width=220, height=40)

        #exit
        img8 =Image.open(r"project_images\exit1.jpg")
